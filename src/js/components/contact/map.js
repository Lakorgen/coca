  ...
  async function main() {
    ymaps3.ready.then(() => {
      ...
      const marker = new ymaps3.YMapMarker(
        {
          coordinates: [133.51145358313894, -22.691745335256936],
          zoom: 2,
        },
        content,
      );
      map.addChild(marker);
      content.innerHTML = `<div class="hero__pin">
      <div class="hero__pin-text">
          <h5 class="hero__pin-title">
            Yogja, INA
          </h5>
          <p class="hero__pin-descr">
